...
def main():
    ...
    add_text(doc, "3.0–5.5 已完成內容設計並保存於資料層，目前不會被現行卡池或玩家劇情入口使用。每個大版本仍維持五個小版本，但新四星改為每個大版本 2–3 名；其餘已設計角色保留為劇情夥伴，依瑟蕾雅的旅程在後續章節登場，不為了卡池硬切斷角色關係。3.2、4.2、5.3 另外保留一名三星，作為偶爾出現的低星角色。", after=7)
    add_table(doc, ["版本", "新角色", "劇情主題", "狀態"], [
        ["3.0–3.5", "霽羅 4★、蘿堤亞 4★、洛恩 4★；岑芽 3★", "第九個回覆 → 終端的第一頁；以獸靈之村的共同生活為情感根", "3 名新四星／保留澄音、諾嵐、艾斯特於故事"],
